...
(100002, 'alt.binaries.*', '[ -.](bl|cz|de|es|fr|ger|heb|hu|ita|ko|kor|nl|pl|se)[ -.]((19|20)\\d\\d|(480|720|1080)(i|p)|(bd|dvd.?|sat|vhs)?rip?|(bd|dl)mux|( -.)?(dub|sub)(ed|bed)?|xbox|complete|convert|(d|h|p|s)d?tv|dirfix|docu|dual|dvbs|dvdscr|eng|(h|x).?2?64|int(ernal)?|pal|proper|repack)', 1, 1, 0, 'Blacklists non-english abbreviated releases.'),
...
(100005, 'alt.binaries.*', '[ -._](vost|nov[ a]+rip|realco|videomann)[ -._]', 1, 1, 0, 'Blacklists non-english (release group specific) releases.'),
