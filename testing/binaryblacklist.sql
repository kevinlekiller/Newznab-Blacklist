...
(100001, 'alt.binaries.*', '(chinese|danish|deutsch|dutch|flemish|finnish|french|german|hebrew|icelandic|italian|nordic|norwegian|japenese|japanese|serbian|spanish|spanisch|swedish|turkish)[\\)]?( -)?[ -.]((19|20)\\d\\d|(480|720|1080)(i|p)|ac3|(bd|dvd.?|hd|sat|vhs|web)rip|(bd.)?(h|x).?2?64|bluray|board|cracked|custom|"|(d|h|p|s)d?tv|dirfix|divx|dl|doc|dub|dts|dvd(-|sc)?r|(f|w)s|incl|ml|nzb|pal|par2|proper|read.?nfo|real|repack|retail|sub|\\(uncut\\)|unrated|winall|xvid)', 1, 1, 0, 'Blacklists non-english releases.'),
