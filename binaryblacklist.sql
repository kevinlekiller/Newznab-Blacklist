...
(100008, 'alt.binaries.*', 'german|danish|flemish|swedish|swesub|deutsch|korsub|GERMAN|Keygen|Giro|norwegian|ita|japanese|GER|ita-eng|FLEMISH|NORWEGIAN|Turkish|FRENCH|SPANiSH', 1, 1, 1, ''),
...
(100022, 'alt.binaries.*', '^[^.^ ]{10,20}$', 1, 1, 1, 'Filters out all hashes between 10 and 20 characters, that haven''t got a space, period or caret in them, a negated character class that starts with a ^, doesn''t have a ^ before every character.'),
...
(100025, 'alt.binaries.*', '^[a-z0-9]{20}', 1, 1, 1, 'Removes crap.'),
...
(100040, 'alt.binaries.*', 'AutoRarPar\\d', 1, 1, 1, 'Removes releases with AutoRarPar\\d in the name.'),
(100043, 'alt.binaries.*', 'L.Joe@no-mans-land.com', 2, 1, 1, 'foreign'),
